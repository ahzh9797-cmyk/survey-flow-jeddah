...
export default function App() {
 ...
 { icon:"", title:"هوية النظام", sub:"الشعار والألوان والبيانات", type:"identity", accent:"#047857" },
 ].map(item => (
 ...
 <Btn full variant="danger" onClick={()=>deleteSurvey(deleteSurveyTarget)}>حذف نهائياً</Btn>
 </div>
 </div>
 </div>
 )}
